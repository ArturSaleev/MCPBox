...
export type Dictionary = {
  ...
  messages: {
    ...
    oauthCallbackURLDescription: string;
  };
};
  ...
  en: {
    ...
    messages: {
      ...
      autoReindexDescription:
        'When enabled, MCPBox will rebuild this Bleve knowledge base automatically every 10 minutes while the app is running.',
      ...
      oauthCallbackURLDescription:
        'Paste the callback URL shown by ChatGPT for this connector. Leave empty only for quick local testing.',
    },
  },
  ru: {
    labels: {
      ...
      oauthCallbackURL: 'URL обратного вызова OAuth',
    ...
    messages: {
      ...
      autoReindexDescription:
        'Если включено, MCPBox будет автоматически пересобирать эту Bleve-базу знаний каждые 10 минут, пока приложение запущено.',
      ...
      oauthCallbackURLDescription:
        'Вставь URL-адрес обратного вызова, который показывает ChatGPT для этого connector. Пустым можно оставить только для быстрой локальной проверки.',
    },
  },
};
